    ...
    <div class="container"> 
        <nav aria-label="breadcrumb" >
            <ol class="breadcrumb" style="background-color: unset;">
                <li class="breadcrumb-item active" aria-current="page">Kamera</li>
            </ol>
        </nav>
                ...
                ?>
                    <div class="col-3 pb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <h5 class="card-title"><?= $laptop['nama_alternatif'] ?></h5>                        
                            <p><?= $laptop['merk'].' '.$laptop['seri_produk'] ?></p>
                            <a href="detail.php?id=<?= $laptop['id_alternatif'] ?>" class="btn btn-primary">Lihat</a>
                            </div>
                        </div>
                    </div>
