        ...
        <div class="row">
            ...
            <h4 class="pb-3">Update Alternatif  </h4>
                    ...
                    <div class="form-group">                        
                        <label for="nama_alternatif">Nama Kamera</label>
                        <input type="text" name="nama_alternatif" class="form-control" value="<?= $alt['nama_alternatif'] ?>"  id="nama_alternatif" Required>                   
                    </div>

                    <div class="form-group">
                          <label for="merk">Merk</label>
                        <input type="text" name="merk" class="form-control" id="merk" value="<?= $alt['merk'] ?>"  Required>          
                    </div>
            ...
            <h4 class="pb-3">Nilai Kriteria.</h4>                                                         
                ...
                <?php 
                    ...
                    $getKriteria = mysqli_query($konek, "SELECT * FROM kriteria_kamera");
                                                                           
                while($k = mysqli_fetch_row($getKriteria)){
                    $id_kriteria = $k[0];
                    $qGetNilai = mysqli_query($konek,"SELECT * FROM nilai_kriteria_kamera WHERE id_alternatif='$idAlternatif' AND id_kriteria = '$id_kriteria' ");
                    ...
                    <input type="hidden" name="id_nilai[]" value="<?= $nilai['id_nilai'] ?>">
                        ...
                        <select name="bobot[]" class="form-control" required>
                            ...
                            <?php 
                                ...
                                <option value="<?= $value ?>" <?php if($nilai['nilai'] == $value ) echo 'selected'  ?> > <?= $k[$a]; ?>  </option>
